...
save(yeast_uniform_footprints, 
     file=file.path(outputDir, "yeast_uniformCodons_uniformDelta_footprints_1Mreads.Rda"))
writeFootprintsFA(yeast_uniform_footprints,
                  file.path(outputDir, "yeast_uniformCodons_uniformDelta_1Mreads.fa"))
...
save(yeast_yeast_footprints, 
     file=file.path(outputDir, "yeast_yeastCodons_yeastDelta_footprints_1Mreads.Rda"))
writeFootprintsFA(yeast_yeast_footprints,
                  file.path(outputDir, "yeast_yeastCodons_uniformDelta_1Mreads.fa"))