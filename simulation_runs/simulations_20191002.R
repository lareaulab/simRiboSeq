...
# simulation_name <- "yeast_uniformCodons_uniformDelta_noBias_extraBase"
...
#                              ligBias=n3bias, RTBias=noRTbias, circBias=p5bias,
...
# 
# # 3. simulate footprints
# simulation_name <- "yeast_uniformCodons_uniformDelta_withBias_extraBase"
# if(!(simulation_name %in% list.files(outputDir))) {
#   system(paste("mkdir", file.path(outputDir, simulation_name)))
# }
# for(i in 1:nParts) {
...
# 
# # 3. simulate footprints
# simulation_name <- "yeast_yeastCodons_uniformDelta_noBias_extraBase"
# if(!(simulation_name %in% list.files(outputDir))) {
#   system(paste("mkdir", file.path(outputDir, simulation_name)))
# }
# for(i in 1:nParts) {
...
# 
# # 3. simulate footprints
# simulation_name <- "yeast_yeastCodons_uniformDelta_withBias_extraBase"
# if(!(simulation_name %in% list.files(outputDir))) {
#   system(paste("mkdir", file.path(outputDir, simulation_name)))
# }
# for(i in 1:nParts) {
